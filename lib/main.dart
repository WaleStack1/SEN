...
class ComputeApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) => MaterialApp(
    ...
    title: 'Compute',
    theme: ThemeData(brightness: Brightness.dark, scaffoldBackgroundColor: const Color(0xFF140C00)),
...
class _ComputeScreenState extends State<ComputeScreen> {
  ...
  // ── palette ────────────────────────────────────────────────────────────
  static const _kBg    = Color(0xFF140C00);
  static const _kSci   = Color(0xFF8D4B00);
  static const _kSciTx = Color(0xFFFFCA28);
  static const _kNum   = Color(0xFF1A1200);
  static const _kOp    = Color(0xFFE65100);
  static const _kOpTx  = Color(0xFFFFCA28);
  static const _kFn    = Color(0xFF1A1200);
  static const _kEq    = Color(0xFFFF6F00);
  static const _kAc    = Color(0xFFB71C1C);

  // ── button widget ───────────────────────────────────────────────────────
  Widget _key(String lbl, VoidCallback fn,
      {Color bg = _kNum, Color fg = Colors.white, int flex = 1, double fs = 14.0}) {
    return Expanded(
      flex: flex,
      child: Padding(
      ...
      body: SafeArea(child: Column(children: [
        ...
        Container(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.end, children: [
            ...
            Text(disp,
              style: TextStyle(
                color: const Color(0xFF1A2A08), fontSize: 36.0,
        ...
        Expanded(child: Padding(
          ...
          child: Column(children: [
            ...
            _row([_key('asin', () => _sci('asin'), bg:_kSci, fg:_kSciTx, fs:12.0), _key('acos', () => _sci('acos'), bg:_kSci, fg:_kSciTx, fs:12.0), _key('atan', () => _sci('atan'), bg:_kSci, fg:_kSciTx, fs:12.0), _key('√x', () => _sci('sqrt'), bg:_kSci, fg:_kSciTx), _key('x²', () => _sci('x²'), bg:_kSci, fg:_kSciTx)]),
            _row([_key('sinh', () => _sci('sinh'), bg:_kSci, fg:_kSciTx, fs:12.0), _key('cosh', () => _sci('cosh'), bg:_kSci, fg:_kSciTx, fs:12.0), _key('tanh', () => _sci('tanh'), bg:_kSci, fg:_kSciTx, fs:12.0), _key('x³', () => _sci('x³'), bg:_kSci, fg:_kSciTx), _key('1/x', () => _sci('1/x'), bg:_kSci, fg:_kSciTx)]),
            _row([_key('n!', () => _sci('n!'), bg:_kSci, fg:_kSciTx), _key('nPr', () => _combo('nPr'), bg:_kSci, fg:_kSciTx, fs:12.0), _key('nCr', () => _combo('nCr'), bg:_kSci, fg:_kSciTx, fs:12.0), _key('π', () => _sci('π'), bg:_kSci, fg:const Color(0xFFFFD54F)), _key('e', () => _sci('e'), bg:_kSci, fg:const Color(0xFFFFD54F))]),
            _row([
